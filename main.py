...
# # this is what which retrieves the data from the vector store
...
#     """
#     This function takes a list of documents and returns a string that can be
...
#     # response = llm.invoke([HumanMessage(content=prompt_template.format(context=formatted_docs, question=query))])
